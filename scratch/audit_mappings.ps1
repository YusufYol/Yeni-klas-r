...
# Canonical F1 Pilot Names mapping (from UPPERCASE to Title Case preserving exact accents)
$f1PilotMap = @{
...
# Canonical F1 Team Names mapping
$f1TeamMap = @{
...
# Canonical MotoGP Pilot Names mapping (Title Case, replacing İ with I if present)
$motoGpPilotMap = @{
    ...
    "TOPRAK RAZGATLIOĞLU #7" = "Toprak Razgatlıoğlu #7"
    "MAVERICK VIÑALES #12" = "Maverick Viñales #12"
    "MAVERICK VINALES #12" = "Maverick Viñales #12"
...
# Canonical MotoGP Team Names mapping
$motoGpTeamMap = @{
...
Write-Host "Mappings created successfully."

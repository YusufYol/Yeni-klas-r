    ...
    "formula 1": {
        "news": [
            ...
            },
            {
                ...
                "cat": "formula 1",
                "date": "2026-09-26 11:49",
                "content": "Azerbaycan Grand Prix’si sıralama turlarında beklentileri karşılayamayan Haas pilotu Esteban Ocon, Q2 seansında yaşanan olaylar neticesinde bir kez daha erken havlu atarken, sezon boyunca yakasını bırakmayan şanssızlıklara dikkat çekti.<br><br>Sezonun 15. mücadelesi öncesi Bakü pistinde umut vadeden bir performans sergileyen Fransız pilot, Q3 biletini cebine koymaya çok yaklaşmıştı. Ancak Arvid Lindblad'ın pist dışına taşmasıyla devreye giren sarı bayraklar, Ocon'un hızlı turunu tamamlamasına engel oldu ve seansı 14. sırada noktalamasına yol açtı. Takım arkadaşı Oliver Bearman'ın 0.241 saniye gerisinde kalan deneyimli sürücü, hafta sonu boyunca aracın potansiyeline inandığını belirtti.<br><br>Yaşadığı hayal kırıklığını dile getiren Ocon, performanslarının karşılığını alamamaktan duyduğu rahatsızlığı şu sözlerle ifade etti:<br>\"Aracın düzgün çalıştığı anlarda bile şansımızın yaver gitmediği durumlar yaşanabiliyor. Geliştirdiğimiz alanlar sayesinde bugün Q3’e kalabilecek hıza sahiptik ve araç gerçekten iyi hissettiriyordu.\"<br><br>\"İlk denememde rüzgâr nedeniyle ideal tempoyu yakalayamasam da yeterli hıza sahip olduğumun farkındaydım. Son denememde ise 15. viraja yaklaşırken aynı dereceyi yakalamıştım. Ancak pist dışına çıkan bir araç nedeniyle yavaşlamak ve gaz kesmek zorunda kaldım. Sarı bayrak kuralına uymak adına kaybettiğim saniyeler turumu tamamen etkiledi.\"<br><br>Sezon genelindeki istikrarsızlıklar ve dış etkenler nedeniyle hedeflerinin gerisinde kaldığını vurgulayan Ocon, yaşananların kendisi adına yıpratıcı bir süreç haline geldiğini belirtti.<br>Bugün gerçekleştirilecek ana yarışta puan mücadelesi verecek olan Haas pilotu, ilk 10 içerisine girmek için tırmanış yarışına imza atmaları gerekeceğinin altını çizdi.",
                "img": "Resimler/Formula 1 Haberler/1790412592667_IMG_9737.jpeg",
                "author": "Azra Şahin",
                "authorImg": "Resimler/Haber Yazarı Fotoğrafları/Azra Şahin.png"
            },
            {
            ...
            {
                "id": 115,
                "title": "MACARISTAN'DA LANDO NORRIS POLE'DE!",
                "cat": "formula 1",
            ...
            },
            {
                ...
                "content": "Aston Martin, sezona yaptığı zorlu başlangıcın ardından radikal bir karara imza atarak Macaristan GP öncesinde tarihinin en kapsamlı güncelleme paketini tanıtmaya hazırlanıyor. Parça parça güncelleme getirmek yerine gelişimi büyük bir pakete saklayan Ingiliz ekibi, Hungaroring’e adeta baştan aşağı yenilenmiş bir \"B-spec\" araçla geliyor. Ön süspansiyon dışındaki neredeyse tüm gövde ve şasi bileşenlerinin baştan tasarlandığı paket, gridde tam anlamıyla yeni bir sayfa açmayı hedefliyor.<br><br>Adrian Newey ve teknik ekibin liderliğinde hazırlanan bu devasa paket, sadece aerodinamik yüzeylerin baştan çizilmesiyle sınırlı değil. Aracın ciddi seviyedeki ağırlık problemini çözmek adına şasi üzerinde agresif bir diyet uygulayan takım, yeni çarpışma testlerinden geçerek yaklaşık 30 kilogramlık ciddi bir hafifleme sağladı. Tamamen yenilenen burun yapısı, aero yüzeyler ve arka süspansiyon mimarisiyle araç, kağıt üzerinde sezon başındaki ilk halinden çok daha farklı ve agresif bir kimliğe büründü.<br><br>Takım yetkilileri beklentileri dengede tutmaya çalışsa da simülasyon verileri ve padok kulisleri devasa bir kazanım potansiyeline işaret ediyor. Ingiliz ekibinin bu radikal adımla ana hedefi ise net: Öncü takımlarla aralarındaki performans farkını yarı yarıya indirmek.<br><br>Yenilenmiş AMR26, Aston Martin’in sezonun geri kalanındaki kaderini ve teknik gelişim yönünü doğrudan belirleyecek.",
            ...
            },
            {
                ...
                "content": "Scuderia Ferrari, sezonun teknik açıdan en kritik yarışlarından biri öncesinde aerodinamik paketinde önemli bir değişikliğe gidiyor. Italyan ekibinin geliştirdiği ve \"Macarena\" olarak adlandırılan güncellenmiş arka kanat hazır durumda. Takımın teknik heyeti son değerlendirmelerin ardından kullanım kararı alırsa, bu yeni arka kanat ilk kez Macaristan GP hafta sonunda piste çıkacak.<br><br>Macaristan’ın ev sahipliği yaptığı Hungaroring, takvimde maksimum yere basma kuvveti (downforce) gerektiren pistlerin başında geliyor. Düzlüklerin kısa, virajların ise oldukça dar ve ardı ardına sıralandığı bu pist yapısı, arka kanadın ürettiği aerodinamik yükü ve araç dengesini doğrudan belirliyor. Ferrari de yarışın bu özel karakteristiğine yanıt verecek en doğru çözümü devreye sokmayı amaçlıyor.<br><br>Yenilenen \"Macarena\" arka kanadı sayesinde şasi üzerindeki hava akışını optimize eden Italyan ekip, arka aksta ekstra yere basma kuvveti elde etmeyi planlıyor. Ferrari’nin bu güncellemedeki ana hedefi ise net: Arka tarafın yere daha güçlü tutunmasını sağlayarak Macaristan GP'nin dar ve teknik virajlarını olabildiğince yüksek hızlarda geçebilmek.",
            ...
            {
                "id": 110,
                "title": "ANDREA KIMI ANTONELLI BELÇIKA GP'YI KAZANDI!",
                "cat": "formula 1",
                "date": "2026-07-19 21:01",
                "content": "Formula 1 dünyası, çakıl havuzundan piste taşan taşlar nedeniyle bolca sanal güvenlik aracının çıktığı ve büyük dramaların yaşandığı unutulmaz bir Belçika Grand Prix'sini geride bıraktı. Yarışa pole pozisyonundan başlayan şampiyona lideri Andrea Kimi Antonelli, Eau Rouge'da liderliği kısa süreliğine kaptırıp geriye düşmesine rağmen yılmadı. Harika bir tempo tutturup her turda performansını geliştiren genç Italyan pilot, harika ataklarla yeniden zirveye tırmanarak damalı bayrağı ilk sırada görmeyi başardı. Yarışın ikincisi ise 4. sıradan kalkan Ferrari pilotu Charles Leclerc oldu. Güvenlik aracı ve sanal güvenlik aracı periyotlarını kusursuz değerlendiren ve güçlü bir ritim yakalayan Leclerc, podyumun ikinci basamağına çıktı. Yarışa ikinci sıradan harika bir startla başlayıp liderliği alan Max Verstappen ise güvenlik aracı süreçlerinde şanssız şekilde geriye düştü. Elinden gelen her şeyi yapmasına rağmen üçüncülükle yetinen Verstappen, podyumu tamamlayan isim oldu.<br> <br>Spa-Francorchamps'ta gözlerin çevrildiği bir diğer olay ise Mercedes ve Ferrari pilotları arasındaki temas oldu. Yarışa 5. sıradan başlayan Ferrari'nin pilotu Lewis Hamilton, ilk turda George Russell ile bir temas yaşadı ve bu olay Russell'ın spin atarak yarış dışı kalmasına neden oldu. Olayın ardından Hamilton 5 saniyelik zaman cezası alsa da pes etmeyerek yarışı 4. sırada tamamlamayı başardı. Kazanın ardından konuşan George Russell ise bunun bir yarış kazası olduğunu vurgulayarak, \"Ben biraz daha genişten dönebilirdim, Hamilton da biraz daha erken fren yapabilirdi\" diyerek durumu olgunlukla değerlendirdi.<br><br>McLaren cephesi ise kendi standartlarında, ne çok iyi ne de çok kötü diyebileceğimiz stabil bir yarış çıkardı; Oscar Piastri 5. sırada finiş görürken, sıralamalarda 3. olmasına rağmen 10 sıralık grid cezası nedeniyle yarışa 13. başlayan Lando Norris, başarılı bir geri dönüşle 7. oldu. Günün en dikkat çeken performanslarından birine ise Red Bull'un genç pilotu Isack Hadjar imza attı. Güç ünitesi değişimi 30 sıra grid cezası aldığı için gridin en arkasından start alan Hadjar, müthiş bir yükseliş grafiği çizerek yarışı 6. sırada bitirdi ve alkış topladı.<br><br>Bol geçişli, bol aksiyonlu geçen Belçika hafta sonunun ardından Formula 1 sirkülasyonu hız kesmeden devam ediyor; heyecan önümüzdeki hafta sonu gerçekleştirilecek Macaristan GP ile kaldığı yerden devam edecek. ",
                "img": "Resimler/Formula 1 Haberler/1784485367702_1000047043.jpg",
                "author": "Yusuf Yol",
                "authorImg": "Resimler/Haber Yazarı Fotoğrafları/Yusuf Yol.png"
            },
            {
                "id": 109,
                "title": "MAX VERSTAPPEN'IN YENI YARIŞ MÜHENDISI TOM HART OLDU!",
                "cat": "formula 1",
                "date": "2026-07-19 15:40",
                "content": "Formula 1 padoğunda taşlar yerinden oynamaya devam ederken, Red Bull Racing cephesinden takımın geleceğini doğrudan etkileyecek çok kritik bir hamle geldi. Hollanda basınının ve padoğun güvenilir isimlerinden Erik van Haren'in özel haberine göre; Max Verstappen ile kazandığı şampiyonluklarda telsiz hattının diğer ucundaki ikonik isim olan Gianpiero Lambiase'nin takımdan ayrılacağı kesinleşti. Lambiase'den boşalacak olan yarış mühendisliği koltuğuna ise gelecek sezondan itibaren Tom Hart’ın getirileceği açıklandı.<br><br>Bu hamleyi asıl çarpıcı kılan unsur ise Tom Hart’ın normal şartlarda takımdan ayrılma arifesinde olmasıydı. Başarılı mühendisin gelecek sezon için Williams'a katılması yönünde daha önceden yapılmış kesin bir anlaşması bulunuyordu. Ancak Red Bull yönetimi, hem takımdaki mühendislik kalitesini korumak hem de istikrarı sağlamak adına devreye girdi. Williams ile yapılan yoğun görüşmeler ve varılan mutabakat sonucunda Ingiliz mühendis Red Bull bünyesinde kalmaya ikna edildi ve Williams transferi resmi olarak iptal edildi.<br><br>Haberin detaylarında yer alan bir diğer önemli stratejik hamle ise bu anlaşmanın tamamen \"Red Bull odaklı\" yapılmış olması. Gelecek sezondan itibaren Verstappen'in performansını doğrudan yönetecek olan Tom Hart, Max Verstappen takımdan ayrılsa dahi Red Bull bünyesindeki yarış mühendisliği görevine devam edecek. Red Bull, bu uzun vadeli planlamayla birlikte sadece Verstappen’in bugününe odaklanmadığını, gelecekteki olası senaryolara karşı da takım yapısını şimdiden güvence altına aldığını tüm padoğa ilan etmiş oldu.",
            ...
            {
                "id": 108,
                "title": "ANDREA KIMI ANTONELLI, BELÇIKA'DA POLE'DE!",
                "cat": "formula 1",
            ...
            {
                "id": 105,
                "title": "BAHREYN GP TEKRAR IPTAL EDILDI!",
                "cat": "formula 1",
            ...
            {
                "id": 99,
                "title": "SILVERSTONE'DA POLE KIMI ANTONELLI'NIN OLDU!",
                "cat": "formula 1",
            ...
            {
                "id": 98,
                "title": "SILVERSTONE'DA SPRINT YARIŞINI KAZANAN ISIM ANDREA KIMI ANTONELLI OLDU!",
                "cat": "formula 1",
            ...
            {
                "id": 54,
                "title": "VALTTERI BOTTAS, MONACO GP'DEN SONRA TAKIMDAN AYRILABILIR!",
                "cat": "formula 1",
            ...
            {
                "id": 52,
                "title": "FERRARI’NIN ILK ELEKTRIKLI OTOMOBILI HAMILTON VE LECLERC TANITTI!",
                "cat": "formula 1",
            ...
            {
                "id": 50,
                "title": "MAX VERSTAPPEN’DEN EMEKLILIK AÇIKLAMASI: “BU ŞEKILDE DEVAM EDEMEM”",
                "cat": "formula 1",
            ...
            {
                "id": 49,
                "title": "GEORGE RUSSELL KANADA’DA POLE POZISYONUNDA!",
                "cat": "formula 1",
            ...
            {
                "id": 47,
                "title": "GEORGE RUSSELL ILK SIRAYA GERI DÖNDÜ: MERCEDESLER SPRINT SIRALAMADA ZIRVEDE!",
                "cat": "formula 1",
            ...
            {
                "id": 45,
                "title": "LEWIS HAMILTON EMEKLILIK IDDIALARINI NET BIR ŞEKILDE REDDETTI!",
                "cat": "formula 1",
                "date": "2026-05-22 00:42",
                "content": "Formula 1 dünyasında dedikodu kazanının ateşi son dönemde hiç sönmüyor, hele ki söz konusu Lewis Hamilton olduğunda. Özellikle son 1-2 sezondur gündemden düşmeyen emeklilik iddiaları, geçtiğimiz yıl Lewis Hamilton'ın Ferrari'de beklenen performans çizgisine ulaşamamasıyla başlamıştı. Ancak bu sezon, bu söylentiler çok daha agresif bir boyuta ulaştı. Kulislere düşen son iddiaya göre Hamilton’ın, önümüzdeki Silverstone GP'sinde spora veda edeceğini açıklayacağı ileri sürüldü. Deneyimli pilot pistte elinden gelenin en iyisini yapıp tüm gücünü ortaya koysa da, Ferrari'nin araca getirdiği yeni güncellemelerin bir türlü beklenen etkiyi yaratamaması ve takımın zirveden uzaklaşması, bu \"Silverstone'da emeklilik\" dedikodularını iyice alevlendirdi.<br><br>Ancak Formula 1’in yaşayan efsanesi, hakkında çıkan bu spekülasyonlara son noktayı koymakta gecikmedi. Yaşanan tüm teknik zorluklara rağmen spora ve geleceğine olan bağlılığını net bir dille ilan eden Hamilton, adeta meydan okuyarak şu açıklamayı yaptı: \"Burada daha uzun bir süre kalacağım, buna alışsanız iyi olur. Emekli olmamı isteyen birçok insan var ama bu, aklımın ucundan bile geçmiyor.\" Britanyalı pilotun bu kararlı duruşu, araçtaki eksiklere ve tüm eleştirilere rağmen pistlerdeki savaşçı ruhunun hâlâ ilk günkü gibi taze olduğunu ve Ferrari ile önündeki yıllara odaklandığını herkese bir kez daha kanıtladı.",
                "img": "Resimler/Formula 1 Haberler/1779399749588_1000043960.jpg",
                "author": "Yusuf Yol",
                "authorImg": "Resimler/Haber Yazarı Fotoğrafları/Yusuf Yol.png"
            },
            {
                "id": 37,
                "title": "MARKO: \"VERSTAPPEN AYRILSA BILE F1 YENI YILDIZINI BULUR\"",
                "cat": "formula 1",
            ...
            {
                "id": 35,
                "title": "HORNER VE WOLFF, ALPINE SAHIPLIĞI SAVAŞINDA KARŞI KARŞIYA!",
                "cat": "formula 1",
            ...
            {
                "id": 1,
                "title": "FERRARI HAMLESIYLE HIBRIT AÇIĞI KAPATILDI!",
                "cat": "formula 1",
                "date": "2026-04-14",
            ...
            {
                "id": 7,
                "title": "GÜNEY KORE, FORMULA 1’E GERI DÖNMEYE HAZIRLANIYOR!",
                "cat": "formula 1",
                "date": "2026-04-17",
            ...
            {
                "id": 10,
                "title": "SON DAKIKA: FIA, F1 KURALLARINDA DEĞIŞIKLIĞE GITTI!",
                "cat": "formula 1",
            ...
            {
                "id": 18,
                "title": "RED BULL RACING ILE ADIDAS ANLAŞMASI RESMIYET KAZANMAK ÜZERE!",
                "cat": "formula 1",
            ...
            {
                "id": 19,
                "title": "ASTON MARTIN, SUZUKA'DAKI GÜNCELLEMEYI MIAMI'YE GETIRMIYOR!",
                "cat": "formula 1",
            ...
            {
                "id": 20,
                "title": "MERCEDES, MIAMI'DE TEMKINLI: BÜYÜK GÜNCELLEMELER MONTREAL'E SAKLANIYOR!",
                "cat": "formula 1",
            ...
            {
                "id": 21,
                "title": "MIAMI’DE CHARLES LECLERC HAFTA SONUNUN TEK ANTRENMANINDA ZIRVEDE: MAX VERSTAPPEN ILK 3’E GERI DÖNDÜ!",
                "cat": "formula 1",
                "date": "2026-05-01 22:00",
                "content": "2026 Formula 1 sezonunun en çok beklenen duraklarından biri olan Miami Grand Prix’si, nefes kesen tek antrenman seansıyla başladı. Beş haftalık aranın ardından takımların büyük güncelleme paketlerini piste sürdüğü bu kritik seansta, Ferrari pilotu Charles Leclerc sergilediği performansla hafta sonuna damga vuracağını şimdiden kanıtladı. Monakolu pilot, yenilenen aracıyla elde ettiği 1:29.310'luk derecesiyle seansı lider tamamlayarak rakiplerine gözdağı verdi.<br><br>Seans boyunca lastik yönetimi ve viraj hızı konusunda oldukça rahat görünen Leclerc, özellikle kompleks düşük hızlı virajlarda rakiplerine ciddi bir üstünlük kurdu. Takım arkadaşı Lewis Hamilton’ın da dördüncü sırada yer alması, 'Şahlanan At'ın Miami sokaklarında galibiyetin en büyük adayı olduğunu gösteriyor.<br><br>Öte yandan, son yarışlarda podyumun uzağında kalan Max Verstappen, liderin yalnızca 0.297 saniye gerisinde ikinci sıraya yerleşti. Verstappen’in bu geri dönüşü, Red Bull cephesinde moralleri yükseltirken, şampiyonluk mücadelesinin Miami’de yeniden kızışacağının sinyallerini verdi.<br><br>Sıralamanın devamında Oscar Piastri üçüncü sırayı alarak McLaren'ın hızını koruduğunu gösterirken, Mercedes pilotları Kimi Antonelli ve George Russell ise ilk 5 içerisinde kendilerine yer buldular. Her iki takım da lider Ferrari ile olan farkı kapatmak için topladıkları verileri analiz etmeye odaklanmış durumda.<br><br>Tek antrenman seansının tamamlanmasıyla birlikte takımlar şimdi doğrudan Sprint sıralama turlarına odaklanacak. Miami’nin kaygan asfaltı ve yüksek sıcaklığı, güncellemelerin dayanıklılığını test etmeye devam edecek. Ferrari bu formunu koruyup pole pozisyonunu alabilecek mi, yoksa Verstappen’in yükselişi bir zaferle mi sonuçlanacak ? Tüm gözler akşam yapılacak sıralama turlarına çevrilmiş durumda.",
                "img": "Resimler/Formula 1 Haberler/Charles.png"
            },
            {
                "id": 22,
                "title": "LANDO NORRIS, MERCEDES’E MEYDAN OKUDU: SPRINT POLE ONUN!",
                "cat": "formula 1",
            ...
            {
                "id": 23,
                "title": "MCLAREN VE FERRARI'DEN GÜÇ GÖSTERGESI: MERCEDES BASKI ALTINDA!",
                "cat": "formula 1",
                "date": "2026-05-02 20:00",
                "content": "Formula 1’de rekabet her geçen yarış daha da kızışırken, McLaren ve Ferrari cephesinden gelen son gelişmeler paddock’ta büyük yankı uyandırdı. Iki köklü ekip, hafta sonuna getirdikleri yeni güncelleme paketleriyle özellikle aerodinamik alanda önemli bir sıçrama gerçekleştirdi.<br><br>Edinilen bilgilere göre McLaren ve Ferrari’nin mevcut paketleri, Mercedes’in en güncel versiyonuna kıyasla 0.4 ila 0.5 saniye arasında performans avantajı sağlıyor. Bu fark, modern Formula 1’de oldukça kritik bir gelişme olarak değerlendiriliyor.<br><br>Aerodinamik Kazanç Yarışın Kaderini Değiştirebilir.<br><br>Her iki takımın da özellikle yere basma kuvveti ve hava akışı yönetimi konusunda ciddi ilerleme kaydettiği belirtiliyor. Bu gelişmeler, sadece tek tur performansını değil, aynı zamanda yarış temposunu da doğrudan etkileyebilecek seviyede.<br><br>Ferrari tarafı, bu pistte McLaren’ın güçlü olmasını zaten öngörüyordu. Ancak iki takımın da bu kadar net bir performans artışı yakalaması, dengeleri tamamen değiştirebilecek bir senaryo ortaya koyuyor.<br><br>Mercedes Için Alarm Zilleri Çalıyor.<br><br>Yaşanan bu gelişmelerin ardından gözler Mercedes’e çevrildi. Sezona güçlü başlayan Alman ekip, rakiplerinin hızlı gelişimi karşısında geri düşme riskiyle karşı karşıya.<br><br>Kulise yansıyan yorumlara göre Mercedes’in planladığı büyük güncellemeleri daha fazla erteleme şansı kalmadı. Aksi takdirde takım, şampiyona mücadelesinde geri planda kalabilir.",
            ...
            },
            {
                ...
                "content": "Lando Norris, Miami’de gerçekleştirilen sprint yarışında üstün bir performans sergileyerek damalı bayrağı ilk sırada gördü. Hafta sonu boyunca piste olan uyumunu net şekilde gösteren genç pilot, starttan itibaren kontrolü elinde tutarak zirveyi kimseye bırakmadı.<br><br>McLaren adına çifte podyum sevinci yaşanırken, Oscar Piastri yarışı ikinci sırada tamamladı ve takımına önemli puanlar kazandırdı. Ingiliz ekibin sprint yarışındaki temposu, ana yarış öncesinde rakiplerine ciddi bir mesaj verdi.<br><br>Öte yandan Charles Leclerc ile temsil edilen Ferrari cephesi, sprint yarışında beklenen performansı tam anlamıyla ortaya koyamadı. Monakolu pilot yarışı üçüncü sırada bitirse de, takımın genel temposu McLaren’in gerisinde kaldı.<br><br>Sprint yarışının ardından gözler şimdi ana yarışa çevrilmiş durumda. McLaren’ın güçlü formunu sürdürüp sürdüremeyeceği ve Ferrari’nin yarış temposunda nasıl bir karşılık vereceği merakla bekleniyor.",
                "img": "Resimler/Formula 1 Haberler/Lando Norris Sprint.png"
            },
            {
                "id": 25,
                "title": "FIA, OLUMSUZ HAVA KOŞULLARI NEDENIYLE MIAMI GRAND PRIX'NIN YARIŞ SAATINI 3 SAAT GERIYE ÇEKTI!",
                "cat": "formula 1",
                "date": "2026-05-03 12:00",
                "content": "Formula 1 dünyasının merakla beklediği Miami Grand Prix’si öncesinde, bölgedeki olumsuz hava koşulları nedeniyle kritik bir program değişikliğine gidildi. FIA ve yarış organizatörleri tarafından yapılan resmi açıklamaya göre, normal şartlarda TSI 23:00’te başlaması planlanan büyük yarış, bölgede beklenen şiddetli fırtına, yıldırım riski ve gök gürültülü sağanak yağış ihtimaline karşı TSI 20:00’ye çekildi.<br><br>Florida eyaletinin katı güvenlik protokolleri gereği, pist çevresinde tespit edilen olası şimşek aktivitelerinin yarışı uzun süre durdurma riski taşıması, bu kararın alınmasındaki en büyük etken oldu. Yarışın kesintisiz bir şekilde tamamlanmasını ve hem pilotların hem de izleyicilerin güvenliğini önceliklendiren organizasyon, start saatini 3 saat öne alarak hava muhalefetinden etkilenmeyecek en uygun zaman dilimini hedefliyor. Formula 1 heyecanı, güncellenen saatiyle bu akşam 20:00’den itibaren ekranlarda olacak.",
                "img": "Resimler/Formula 1 Haberler/Miami Grand Prix Yarış Saati.png"
            },
            {
                "id": 26,
                "title": "MIAMI'DE ANTONELLI FIRTINASI: GENÇ PILOT BU SEZON ÜST ÜSTE ÜÇÜNCÜ KEZ YARIŞ KAZANDI!",
                "cat": "formula 1",
                "date": "2026-05-03 22:30",
                "content": "Miami Grand Prix’si, strateji hataları ve pist üstü savaşlarıyla son yılların en unutulmaz yarışlarından birine sahne oldu. Yarışa pole pozisyonunda başlayan Kimi Antonelli, damalı bayrağı ilk sırada görerek üst üste üçüncü galibiyetini alırken bu zafer hiç de kolay gelmedi. Yarışın büyük bölümünde Lando Norris ile nefes kesen bir liderlik mücadelesine tutuşan Antonelli, rakibinin sert ataklarına ve zaman zaman gerçekleşen geçiş hamlelerine rağmen soğukkanlılığını korudu. Norris, yarış boyunca Antonelli’nin ensesinde adeta bir gölge gibi kalarak galibiyetin en büyük adayı olduğunu hissettirse de, strateji ve savunma disiplini Antonelli’yi Miami’de pole’den kazanmayı başaran ilk pilot yaptı.McLaren'ın diğer pilotu Oscar Piastri ise istikrarlı sürüşüyle 3. sırayı alarak takımını podyumda çiftledi.<br><br>Yarışın kaderini değiştiren anlar ise pistin iki farklı noktasında yaşanan kaosla geldi. Sadece Pierre Gasly ve Liam Lawson arasındaki temas sonucu Gasly'nin yarış dışı kalması ve Hadjar’ın spin atarak yarış dışı kalması güvenlik aracının girmesine neden oldu. Bu karmaşayı fırsata çevirmek isteyen Max Verstappen, erken bir hamleyle pite girdi. Yarışın başında attığı spinle geriye düşen Hollandalı pilot, yeni lastikleriyle bir ara yükselişe geçse de yarışın sonlarına doğru lastik ömrünü tamamlayınca 5. sıraya kadar gerilemekten kurtulamadı.<br><br>Final turları ise tam bir dramaya sahne oldu. Yarışın başından beri Antonelli’nin takım arkadaşı olarak ritim bulmakta zorlanan George Russell, son bölümde hızlanarak 4. sıraya yerleşti. Ancak asıl kayıp Charles Leclerc cephesinde yaşandı. Bitime sadece 1,5 tur kala spin atarak bariyerlere çarpan ve aracında hasar oluşan Leclerc, finişe ulaşmaya çalışırken Piastri ve Russell’a geçildi. Yarışın en ikonik anlarından biri ise son virajda yaşandı; hasarlı aracıyla direnen Leclerc, Verstappen’e de geçilerek yarışı 6. sırada noktaladı. Miami, Antonelli’nin yükselişini ve son saniyeye kadar değişen sıralamalarıyla Formula 1'in unutulmaz yarışlarından biri oldu.",
                "img": "Resimler/Formula 1 Haberler/Miami Antonelli.png"
            },
            {
                "id": 27,
                "title": "CHARLES LECLERC'E 20 SANIYE CEZA GELDI: MAX VERSTAPPEN'DE 5 SANIYE CEZA YEDI!",
                "cat": "formula 1",
            ...
            {
                "id": 30,
                "title": "TÜRKIYE GP’SI BU SEZON GERÇEKLEŞEBILIR!",
                "cat": "formula 1",
                "date": "2026-05-06 20:10",
                "content": "Formula 1 dünyasında Türkiye’yi heyecanlandıran haber, doğrudan en üst merciden geldi.<br><br>FIA Başkanı Mohammed Ben Sulayem, yaptığı son açıklamalarla Türkiye’nin yeniden Formula 1 takvimine dahil olabileceğinin güçlü sinyallerini verdi. Özellikle bölgedeki jeopolitik durumlar veya operasyonel nedenlerle Bahreyn veya Suudi Arabistan yarışlarının bu sezon takvimde yer alamama ihtimali, rotanın yeniden Istanbul’a kırılmasına neden oldu. FIA’nın bu alternatif planı, Türkiye GP’nin sadece bir ihtimal değil, masadaki en ciddi aday olduğunu gösteriyor.<br><br>Ben Sulayem’in 'Bahreyn ya da Suudi Arabistan yarışları düzenlenemezse bu sezon Türkiye’ye dönebiliriz' şeklindeki açık beyanı, Istanbul Park’ın yeniden motor sesleriyle yankılanması için kapıları ardına kadar araladı. Takvimin lojistik bütünlüğünü korumak ve boşlukları en kaliteli pistlerle doldurmak isteyen Formula 1 yönetimi için Türkiye, geçmişteki başarılı organizasyonlarıyla en güvenilir liman olarak görülüyor. Eğer süreç bu yönde ilerlerse, Türk yarışseverler bu sezon beklenmedik bir sürprizle Formula 1 heyecanını canlı olarak yerinde izleme fırsatı yakalayabilir.",
                "img": "Resimler/Formula 1 Haberler/Istanbul Park 2.png"
            },
            {
                "id": 31,
                "title": "MAX VERSTAPPEN LE MANS IÇIN FORD ILE TEMAS HALINDE!",
                "cat": "formula 1",
            ...
            {
                "id": 32,
                "title": "FERRARI’NIN 2026’DAKI ANA PROBLEMLERINDEN BIRI TURBO OLABILIR!",
                "cat": "formula 1",
                "date": "2026-05-12 21:00",
                "author": "Yusuf Yol",
                "authorImg": "Resimler/Haber Yazarı Fotoğrafları/Yusuf Yol.png",
                "content": "2026 Formula 1 teknik yönetmelikleri yaklaşırken, güç üniteleri arasındaki felsefe farkları netleşmeye başladı. Ferrari’nin, rakipleri Mercedes ve Red Bull-Ford’a kıyasla yaklaşık 10 mm daha küçük çaplı bir Garrett turbo konfigürasyonunu tercih ettiği öğrenildi. MGU-H sisteminin artık kullanılmayacağı yeni dönemde bu tercih, Italyan ekibine özellikle düşük devirlerde ve duruştan kalkış anlarında (race starts) büyük bir avantaj sağlıyor. Küçük turbo, daha az egzoz gazıyla çok daha hızlı devirlenerek 'turbo gecikmesini' (turbo lag) minimize ediyor ve bataryanın şarj edilme verimliliğini artırıyor.<br><br>Ancak bu kompakt tasarımın bir bedeli var. Ferrari mühendisleri, küçük turbonun yüksek devirlerde nefesinin kesilmesi nedeniyle rakiplerine kıyasla yaklaşık 7 beygir gücü civarında bir kayıp yaşayabileceğini öngörüyor. Mercedes ve Red Bull daha büyük pervanelerle yüksek hızlarda maksimum güç üretimine odaklanırken, Ferrari'nin bu 'verimlilik odaklı' yaklaşımı, özellikle startlarda ve viraj çıkışlarındaki ivmelenmede fark yaratmayı hedefliyor. Maranello'nun bu teknik tercihi, 2026'nın batarya yönetimine dayalı yeni yarış karakterinde ya dahiyane bir strateji ya da düzlük hızında bir dezavantaj olarak tarihe geçecek.",
                "img": "Resimler/Formula 1 Haberler/Ferrari.png"
            },
            {
                "id": 33,
                "title": "TOSFED BAŞKANI EREN ÜÇLERTOPRAĞI: “SÜRECI YAKINDAN TAKIP EDIYORUZ!”",
                "cat": "formula 1",
                "date": "2026-05-14 10:00",
                "author": "Yusuf Yol",
                "authorImg": "Resimler/Haber Yazarı Fotoğrafları/Yusuf Yol.png",
                "content": "Türkiye Otomobil Sporları Federasyonu Başkanı Eren Üçlertoprağı, TRT Spor ekranlarında Türk motor sporları dünyasını heyecanlandıran açıklamalarda bulundu. Istanbul Park’ın geleceği ve Formula 1 takvimi hakkında konuşan Üçlertoprağı, Bahreyn ve Cidde gibi bölge yarışlarının durumunu yakından takip ettiklerini belirterek, 'Resmi bir durum olmasa da ülkemiz için bir fırsat doğarsa elimizden geleni yaparız. Ben Sulayem’in açıklamaları bu noktada çok değerli ve iyi niyetli,' ifadelerini kullandı.<br><br>Dünya Superbike Şampiyonası'ndaki gururumuz Toprak Razgatlıoğlu için özel bir parantez açan Üçlertoprağı, şampiyon pilotun kendi evinde yarışmasının önemine değindi. Üçlertoprağı, 'Bir Türk olarak hepimizin, Toprak Razgatlıoğlu'nu kendi ülkesinde, Istanbul Park'ta yarıştırılmasının bir borç olduğunu düşünüyorum. Inşallah çok yakında bu gerçekleşecek,' diyerek MotoGP veya WSBK’nın Türkiye’ye dönüş sinyallerini verdi.<br><br>F4 Italya serisinde fırtına gibi esen ve şampiyona liderliğine oturan genç yeteneğimiz Alp Aksoy’un başarısına dikkat çeken Başkan, bu serinin Lando Norris ve Kimi Antonelli gibi yıldızları çıkardığını hatırlattı. Alp’in kariyer planlamasının çok doğru ilerlediğini vurgulayan Üçlertoprağı, tarihi bir tarih verdi: 'Bir aksilik olmazsa, 2027'nin ilk yarışında Alp'i Formula 3 pilotu olarak ülkemizde, Istanbul Park'ta yarışırken göreceğiz.'<br><br>Son olarak DTM şampiyonluğu ile göğsümüzü kabartan Ayhancan Güven’e değinen Üçlertoprağı, bu başarının Türk otomobil sporları tarihindeki en büyük başarı olduğunu ifade etti. Ayhancan'ın önünün çok açık olduğunu ve temsilcimizin dünya çapındaki elit pilotlar arasında yerini sağlamlaştırdığını dile getirdi.",
                "img": "Resimler/Formula 1 Haberler/Eren Üçlertoprağı.png"
            },
            {
                "id": 34,
                "title": "MONTOYA'DAN ÇARPICI IDDIA: “RED BULL’UN GURURU CHRISTIAN HORNER’IN DÖNÜŞÜNE ENGEL OLUR!”",
                "cat": "formula 1",
                "date": "2026-05-14 12:00",
                "author": "Yusuf Yol",
                "authorImg": "Resimler/Haber Yazarı Fotoğrafları/Yusuf Yol.png",
                "content": "Formula 1 dünyasının isimlerinden Juan Pablo Montoya, Christian Horner’ın spora olası dönüşü ve Red Bull ile olan bağları hakkında çarpıcı açıklamalarda bulundu. Horner’ın tecrübesinin padok için büyük bir değer olduğunu vurgulayan Montoya, buna rağmen Red Bull’un kurumsal gururunun eski takım patronunun geri dönüşüne engel teşkil edebileceğini savundu. Kolombiyalı pilot, Horner gibi bir liderin Alpine, Aston Martin veya Haas gibi yeniden yapılanma sürecindeki takımlar için 'tek doğru cevap' olabileceğini belirterek; bu tür bir hamlenin ilgili takımları hızla üst sıralara taşıyabileceğini ifade etti.<br><br>Geri dönüşlerin spora kattığı ivmeyi Flavio Briatore üzerinden örneklendiren Montoya, Briatore’nin yirmi yıllık bir aradan sonra Alpine’e dönmesiyle birlikte takımın performansının gözle görülür şekilde arttığını ve stratejik hamlelerin hızlandığını hatırlattı. FIA Başkanı Mohammed Ben Sulayem de bu tartışmalara katılarak Horner’a olan desteğini açıkça dile getirdi. Horner ile düzenli olarak iletişimde olduğunu ve onun 'temiz bir kalbe' sahip olduğunu belirten Ben Sulayem, Ingiliz yöneticinin Formula 1’e dönme arzusunu hissettiğini ve geri döndüğünde sanki sadece kısa bir tatile çıkmış gibi kaldığı yerden devam edeceğine inandığını sözlerine ekledi.",
    ...
    "haberler": {
        "news": [
            ...
            },
            {
                ...
                "content": "TOSFED İstanbul Park, Türk motor sporlarını uluslararası arenanın zirvesine taşıma ve pistimizi bölgemizin en önemli cazibe merkezi haline getirme hedefi doğrultusunda dev bir organizasyona daha ev sahipliği yapmaya hazırlanıyor. Tesisimiz, 6-8 Kasım tarihlerinde Driving Force Events kapsamında gerçekleştirilecek olan \"GT Grand Finals / İstanbul\" sprint yarışı ile dünya çapındaki otomobil sporları tutkunlarını İstanbul’da buluşturacak. Ülkemizin tanıtımına ve spor turizmine büyük bir ivme kazandırma vizyonuyla sürdürdüğümüz yoğun çalışmalar, meyvelerini vermeye devam ediyor.<br><br>Yaklaşık 20 yıllık uzun bir aranın ardından üst düzey GT otomobillerinin nefes kesen mücadelesini yeniden İstanbul Park’ın ikonik asfaltına taşımanın gururunu yaşadıklarını belirten TOSFED Başkanı Eren Üçlertoprağı yaptığı açıklamada; \"TOSFED İstanbul Park’taki yeni bir uluslararası yarışın müjdesini vermek istiyoruz! Pistimizi, bölgemizdeki otomobil sporlarının uluslararası cazibe merkezi yaparak, ülkemizin tanıtımı ve spor turizmine katkı yapmak hedefiyle yürüttüğümüz yoğun çalışmalar sayesinde, tesisteki organizasyonlarımızın sayısı gittikçe artıyor. Bu bağlamda, yaklaşık 20 sene sonra yeniden üst düzey GT otomobillerinin heyecanını yaşamak isteyen herkesi, şimdiden TOSFED İstanbul Park'a davet ediyoruz.\" sözleriyle tüm hız tutkunlarını bu tarihi anlara tanıklık etmeye çağırdı.<br><br>Dünyanın en prestijli GT araçlarının ve usta pilotlarının nefes kesen geçişlerine, yüksek motor seslerine ve kıyasıya rekabetine sahne olacak bu dev organizasyon, İstanbul’u yeniden küresel motor sporlarının odak noktası haline getirecek. Hız, mühendislik ve adrenalinin zirveye çıkacağı GT Grand Finals heyecanını yerinde yaşamak için şimdiden takvimlerinizde yer açın ve TOSFED İstanbul Park’taki bu büyük şölene ortak olun!",
                "img": "Resimler/Formula 1 Haberler/1784812626971_1000047330.jpg",
                "author": "Yusuf Yol",
                "authorImg": "Resimler/Haber Yazarı Fotoğrafları/Yusuf Yol.png",
                "customBadge": "GT GRAND FINALS"
            },
            {
                "id": 104,

        ...
        "news": [
            {
                ...
                "content": "Aston Martin, sezona yaptığı zorlu başlangıcın ardından radikal bir karara imza atarak Macaristan GP öncesinde tarihinin en kapsamlı güncelleme paketini tanıtmaya hazırlanıyor. Parça parça güncelleme getirmek yerine gelişimi büyük bir pakete saklayan İngiliz ekibi, Hungaroring’e adeta baştan aşağı yenilenmiş bir \"B-spec\" araçla geliyor. Ön süspansiyon dışındaki neredeyse tüm gövde ve şasi bileşenlerinin baştan tasarlandığı paket, gridde tam anlamıyla yeni bir sayfa açmayı hedefliyor.<br><br>Adrian Newey ve teknik ekibin liderliğinde hazırlanan bu devasa paket, sadece aerodinamik yüzeylerin baştan çizilmesiyle sınırlı değil. Aracın ciddi seviyedeki ağırlık problemini çözmek adına şasi üzerinde agresif bir diyet uygulayan takım, yeni çarpışma testlerinden geçerek yaklaşık 30 kilogramlık ciddi bir hafifleme sağladı. Tamamen yenilenen burun yapısı, aero yüzeyler ve arka süspansiyon mimarisiyle araç, kağıt üzerinde sezon başındaki ilk halinden çok daha farklı ve agresif bir kimliğe büründü.<br><br>Takım yetkilileri beklentileri dengede tutmaya çalışsa da simülasyon verileri ve padok kulisleri devasa bir kazanım potansiyeline işaret ediyor. İngiliz ekibinin bu radikal adımla ana hedefi ise net: Öncü takımlarla aralarındaki performans farkını yarı yarıya indirmek.<br><br>Yenilenmiş AMR26, Aston Martin’in sezonun geri kalanındaki kaderini ve teknik gelişim yönünü doğrudan belirleyecek.",
            ...
            {
                "id": 18,
                "title": "RED BULL RACİNG İLE ADİDAS ANLAŞMASI RESMİYET KAZANMAK ÜZERE!",
                "cat": "formula 1",
            ...
            {
                "id": 21,
                "title": "MIAMI’DE CHARLES LECLERC HAFTA SONUNUN TEK ANTRENMANINDA ZİRVEDE: MAX VERSTAPPEN İLK 3’E GERİ DÖNDÜ!",
                "cat": "formula 1",
            ...
            {
                "id": 26,
                "title": "MIAMI'DE ANTONELLİ FIRTINASI: GENÇ PİLOT BU SEZON ÜST ÜSTE ÜÇÜNCÜ KEZ YARIŞ KAZANDI!",
                "cat": "formula 1",
            ...
            {
                "id": 27,
                "title": "CHARLES LECLERC'E 20 SANİYE CEZA GELDİ: MAX VERSTAPPEN'DE 5 SANİYE CEZA YEDİ!",
                "cat": "formula 1",
            ...
            {
                "id": 33,
                "title": "TOSFED BAŞKANI EREN ÜÇLERTOPRAĞI: “SÜRECİ YAKINDAN TAKİP EDİYORUZ!”",
                "cat": "formula 1",
                "date": "2026-05-14 10:00",
                "author": "Yusuf Yol",
                "authorImg": "Resimler/Haber Yazarı Fotoğrafları/Yusuf Yol.png",
                "content": "Türkiye Otomobil Sporları Federasyonu Başkanı Eren Üçlertoprağı, TRT Spor ekranlarında Türk motor sporları dünyasını heyecanlandıran açıklamalarda bulundu. İstanbul Park’ın geleceği ve Formula 1 takvimi hakkında konuşan Üçlertoprağı, Bahreyn ve Cidde gibi bölge yarışlarının durumunu yakından takip ettiklerini belirterek, 'Resmi bir durum olmasa da ülkemiz için bir fırsat doğarsa elimizden geleni yaparız. Ben Sulayem’in açıklamaları bu noktada çok değerli ve iyi niyetli,' ifadelerini kullandı.<br><br>Dünya Superbike Şampiyonası'ndaki gururumuz Toprak Razgatlıoğlu için özel bir parantez açan Üçlertoprağı, şampiyon pilotun kendi evinde yarışmasının önemine değindi. Üçlertoprağı, 'Bir Türk olarak hepimizin, Toprak Razgatlıoğlu'nu kendi ülkesinde, İstanbul Park'ta yarıştırılmasının bir borç olduğunu düşünüyorum. İnşallah çok yakında bu gerçekleşecek,' diyerek MotoGP veya WSBK’nın Türkiye’ye dönüş sinyallerini verdi.<br><br>F4 İtalya serisinde fırtına gibi esen ve şampiyona liderliğine oturan genç yeteneğimiz Alp Aksoy’un başarısına dikkat çeken Başkan, bu serinin Lando Norris ve Kimi Antonelli gibi yıldızları çıkardığını hatırlattı. Alp’in kariyer planlamasının çok doğru ilerlediğini vurgulayan Üçlertoprağı, tarihi bir tarih verdi: 'Bir aksilik olmazsa, 2027'nin ilk yarışında Alp'i Formula 3 pilotu olarak ülkemizde, İstanbul Park'ta yarışırken göreceğiz.'<br><br>Son olarak DTM şampiyonluğu ile göğsümüzü kabartan Ayhancan Güven’e değinen Üçlertoprağı, bu başarının Türk otomobil sporları tarihindeki en büyük başarı olduğunu ifade etti. Ayhancan'ın önünün çok açık olduğunu ve temsilcimizin dünya çapındaki elit pilotlar arasında yerini sağlamlaştırdığını dile getirdi.",
                "img": "Resimler/Formula 1 Haberler/Eren Üçlertoprağı.png"
            },
            {
                "id": 34,
                "title": "MONTOYA'DAN ÇARPICI İDDİA: “RED BULL’UN GURURU CHRISTIAN HORNER’IN DÖNÜŞÜNE ENGEL OLUR!”",
                "cat": "formula 1",

const APP_DATA = {
    ...
    "motogp": {
        "news": [
            {
                "id": 59,
                "title": "İTALYA'DA SPRİNT YARIŞINI KAZANAN İSİM RAUL FERNANDEZ OLDU!",
                "cat": "motogp",
                "date": "2026-05-30 16:42",
                "content": "MotoGP İtalya GP’de heyecan, Mugello pistinde koşulan nefes kesici Sprint yarışı ile başladı. Yarışın en büyük sürprizine imza atan Raul Fernandez, damalı bayrağı ilk sırada görerek podyumun zirvesine çıkmayı başardı. Şampiyonluk mücadelesini sürdüren Jorge Martin yarışı ikinci sırada tamamlarken, podyumun son basamağını ise istikrarlı performansıyla göz dolduran Fabio Di Giannantonio kaptı.<br><br>Yarışa pole pozisyonundan başlayarak büyük bir avantaja sahip olan Marco Bezzecchi liderliğini koruyamadı ve mücadeleyi dördüncü sırada noktaladı. Geçirdiği sakatlığın ardından pistlere geri dönen sekiz kat dünya şampiyonu Marc Marquez ise sergilediği güçlü geri dönüş performansıyla yarışı beşinci sırada bitirerek önemli puanları hanesine yazdırmayı bildi.<br><br>Temsilcimiz Toprak Razgatlıoğlu ise Sprint Yarışını 17. sırada tamamladı.<br><br>Mugello'da Sprint yarışının ardından gözler şimdi pazar gününe çevrildi. Sürücülerin podyumun en üst basamağı için büyük bir taktik savaşına gireceği ana yarış, yarın saat 15.00'te başlayacak.",

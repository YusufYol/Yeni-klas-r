        ...
        "news": [
            {
                ...
                "content": "MotoGP İtalya GP’de heyecan, Mugello pistinde yapılan nefes kesici Sprint yarışı ile başladı. Yarışın en büyük sürprizine imza atan Raul Fernandez, damalı bayrağı ilk sırada görerek podyumun zirvesine çıkmayı başardı. Şampiyonluk mücadelesini sürdüren Jorge Martin yarışı ikinci sırada tamamlarken, podyumun son basamağını ise istikrarlı performansıyla göz dolduran Fabio Di Giannantonio kaptı.<br><br>Yarışa pole pozisyonundan başlayarak büyük bir avantaja sahip olan Marco Bezzecchi liderliğini koruyamadı ve mücadeleyi dördüncü sırada noktaladı. Geçirdiği sakatlığın ardından pistlere geri dönen Marc Marquez ise sergilediği güçlü geri dönüş performansıyla yarışı beşinci sırada bitirerek önemli puanları hanesine yazdırmayı bildi.<br><br>Temsilcimiz Toprak Razgatlıoğlu ise Sprint Yarışını 17. sırada tamamladı.<br><br>Mugello'da Sprint yarışının ardından gözler şimdi pazar gününe çevrildi. Sürücülerin podyumun en üst basamağı için büyük bir taktik savaşına gireceği ana yarış, yarın saat 15.00'te başlayacak.",
